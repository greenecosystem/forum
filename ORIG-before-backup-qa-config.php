...
*/
	...
	define('QA_MYSQL_HOSTNAME', '184.168.154.60'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'agriproducts');
	define('QA_MYSQL_PASSWORD', 'Agri@123');
	define('QA_MYSQL_DATABASE', 'agriproducts');
