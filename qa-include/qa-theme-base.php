...
*/
	...
	*/
	...
	//	search() outputs <div class="qa-search">, q_list() outputs <div class="qa-q-list">, etc...
		...
		{
			$this->output('<input type="submit" value="'.$search['button_label'].'" style="height:40px; width:90px; color:#0040FF; background: #0dd39d; opacity: 1; font-family:Comic Sans MS, cursive, sans-serif; font-size: 15px;"  class="qa-search-button"/>');
		}
		...
		function attribution()
		{
			...
			$this->output(
				...
				'Powered by <a href="http://www.greenecosystem.in/">www.greenecosystem.in</a>',
				'</div>'
			);
		}
